...
See [the Code documentation]({% link Just-The-Docs-Tutorial/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link Just-The-Docs-Tutorial/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({% link Just-The-Docs-Tutorial/customization.md %}) for more information.
...
See [Callouts]({% link Just-The-Docs-Tutorial/ui-components/callouts.md %}) for more information.
