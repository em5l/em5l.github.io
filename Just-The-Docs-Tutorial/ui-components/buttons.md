...
Wrap the button in a container that uses the [font-size utility classes]({% link Just-The-Docs-Tutorial/utilities/typography.md %}) to scale buttons:
...
Use the [margin utility classes]({% link Just-The-Docs-Tutorial/utilities/layout.md %}#spacing) to add spacing between two buttons in the same block.
